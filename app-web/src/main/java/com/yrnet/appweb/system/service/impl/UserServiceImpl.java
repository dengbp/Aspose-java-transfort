package com.yrnet.appweb.system.service.impl;
...
import com.yrnet.appweb.common.utils.MD5Util;
import com.yrnet.appweb.common.utils.SortUtil;
import com.yrnet.appweb.common.utils.SpringContextUtil;
...
import com.yrnet.appweb.system.mapper.UserMapper;
import com.yrnet.appweb.system.mapper.UserRoleMapper;
import com.yrnet.appweb.system.service.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public IPage<User> findUserDetail(User user, QueryRequestPage request) {
        try {
            ...
            SortUtil.handlePageSort(request, page, "userId", ViewWebConstant.ORDER_ASC, false);
    ...
    public void updateUser(User user) throws Exception {
        ...
        cacheService.saveRoles(user.getUsername(),roleService);
