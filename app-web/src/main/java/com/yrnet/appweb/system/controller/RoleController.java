...
import com.yrnet.appweb.system.service.IRoleMenuService;
import com.yrnet.appweb.system.service.IRoleService;
...
public class RoleController extends BaseController {
    ...
    public void addRole(@Valid Role role) throws DocumentException {
        try {
    ...
    public void deleteRoles(@NotBlank(message = "{required}") @PathVariable String roleIds) throws DocumentException {
        try {
    ...
    public void updateRole(Role role) throws DocumentException {
        try {
    ...
    public void export(QueryRequestPage queryRequest, Role role, HttpServletResponse response) throws DocumentException {
        try {
