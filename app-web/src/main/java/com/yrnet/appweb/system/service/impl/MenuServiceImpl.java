...
import com.yrnet.appweb.system.mapper.MenuMapper;
import com.yrnet.appweb.system.service.IMenuService;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements IMenuService {
    ...
    public Map<String, Object> findMenus(Menu menu) {
        ...
        try {
            ...
            result.put("ids", ids);
            if (StringUtils.equals(menu.getType(), ViewWebConstant.TYPE_BUTTON)) {
