...
public interface ICacheService {
     ...
     * @param username 用户名
     */
    void saveRoles(String username,IRoleService roleService) throws Exception;
     ...
     * @param username 用户名
     */
    void savePermissions(String username,IMenuService menuService) throws Exception;
     ...
     * @param userId 用户 ID
     */
    void saveUserConfigs(String userId,IUserConfigService userConfigService) throws Exception;
