...
import com.yrnet.appweb.common.entity.LimitType;
import com.yrnet.appweb.common.exception.LimitAccessException;
...
public class LimitAspect extends AspectSupport {
    ...
    @Pointcut("@annotation(com.yrnet.appweb.common.annotation.Limit)")
