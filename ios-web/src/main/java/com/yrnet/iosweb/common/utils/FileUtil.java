...
public class FileUtil {
    ...
    private static Boolean fileTypeIsValid(String fileType) {
        ...
        return ArrayUtils.contains(ViewWebConstant.VALID_FILE_TYPE, fileType);
    }
    ...
    public static String getFilePath(ViewWebProperties erpProperties, String originName){
        String storeName = DateUtil.current_yyyyMMdd() + "_"+ SeqUtil.nextId() + "_"+ originName;
        log.info("保存的文件名为: {}",storeName);
        String path = erpProperties.getVideo_path() + storeName;
