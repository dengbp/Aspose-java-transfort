package com.yrnet.iosweb.common.generator;
...
public class CodeGenerator {
    ...
    private static String projectName = "ios-web";
    ...
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.ios.iosweb.business";
    // xml 文件模板
