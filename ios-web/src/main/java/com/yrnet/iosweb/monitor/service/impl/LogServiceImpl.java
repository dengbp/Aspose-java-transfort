package com.yrnet.iosweb.monitor.service.impl;
...
import com.yrnet.iosweb.common.utils.AddressUtil;
import com.yrnet.iosweb.common.utils.SortUtil;
import com.yrnet.iosweb.monitor.entity.SysLog;
import com.yrnet.iosweb.monitor.mapper.LogMapper;
import com.yrnet.iosweb.monitor.service.ILogService;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, SysLog> implements ILogService {
    ...
    public IPage<SysLog> findLogs(QueryRequestPage request, SysLog sysLog) {
        try {
            ...
            SortUtil.handlePageSort(request, page, "createTime", ViewWebConstant.ORDER_DESC, true);
