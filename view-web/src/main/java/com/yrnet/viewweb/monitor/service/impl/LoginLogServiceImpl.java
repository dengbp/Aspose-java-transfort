package com.yrnet.viewweb.monitor.service.impl;
...
import com.yrnet.viewweb.common.utils.AddressUtil;
import com.yrnet.viewweb.common.utils.HttpContextUtil;
import com.yrnet.viewweb.common.utils.IPUtil;
import com.yrnet.viewweb.common.utils.SortUtil;
import com.yrnet.viewweb.monitor.entity.LoginLog;
import com.yrnet.viewweb.monitor.mapper.LoginLogMapper;
import com.yrnet.viewweb.monitor.service.ILoginLogService;
...
public class LoginLogServiceImpl extends ServiceImpl<LoginLogMapper, LoginLog> implements ILoginLogService {
    ...
    public IPage<LoginLog> findLoginLogs(LoginLog loginLog, QueryRequestPage request) {
        ...
        SortUtil.handlePageSort(request, page, "loginTime", ViewWebConstant.ORDER_DESC, true);
