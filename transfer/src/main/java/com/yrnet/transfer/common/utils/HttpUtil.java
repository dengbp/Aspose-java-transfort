...
import com.yrnet.transfer.common.http.HttpClientResponse;
 ...
 * @param response
     ...
     **/
    public static int send(String url, String operateType, String param, HttpClientResponse response) throws Exception{
        ...
        log.info("连接器服务响应内容[{}]",response.getData());
