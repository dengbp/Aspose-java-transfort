package com.yrnet.sso.server.controller.resolver;

import com.yrnet.sso.server.core.exception.XxlSsoException;
...
public class WebExceptionResolver implements HandlerExceptionResolver {
    ...
    public ModelAndView resolveException(HttpServletRequest request,
        ...
        if (ex instanceof XxlSsoException) {
            ...
            errorResult = new ReturnT<String>(ReturnT.FAIL_CODE, ex.toString().replaceAll("", "<br/>"));
        }
