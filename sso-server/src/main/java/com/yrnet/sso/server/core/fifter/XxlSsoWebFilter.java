package com.yrnet.sso.server.core.fifter;

import com.yrnet.sso.server.config.Conf;
import com.yrnet.sso.server.core.login.SsoWebLoginHelper;
import com.yrnet.sso.server.core.path.impl.AntPathMatcher;
...
public class XxlSsoWebFilter extends HttpServlet implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        UserInfo xxlUser = SsoWebLoginHelper.loginCheck(req, res);
