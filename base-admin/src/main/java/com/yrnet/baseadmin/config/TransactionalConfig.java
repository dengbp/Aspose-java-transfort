...
import com.yrnet.baseadmin.common.exception.BaseAdminException;
...
public class TransactionalConfig {
    ...
    public TransactionInterceptor txAdvice() {
        ...
        required.setRollbackRules(Collections.singletonList(new RollbackRuleAttribute(BaseAdminException.class)));
        ...
        attributesMap.put("handle*", required);
        //查询开启只读
